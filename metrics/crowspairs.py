...
def evaluate(tokenizer, model):
    ...
    with tqdm(total=total) as pbar:
        for index, data in df_data.iterrows():
            ...
            # Append each row's data as a dictionary to the list
    ...
    df_score = pd.DataFrame(data_to_append)
